...
to setup
  clear-all
  set-default-shape hydrogens "molecule hydrogen"
  set-default-shape oxygens "molecule oxygen"
  set-default-shape waters "molecule water"
  create-hydrogens 2000
...
"" ""
PENS
"hydrogen" 1.0 0 -7500403 true "" "plot count hydrogens"
"oxygen" 1.0 0 -2674135 true "" "plot count hydrogens"
"water" 1.0 0 -13345367 true "" "plot count waters"
"total mass (/100)" 1.0 0 -16777216 true "" "plot sum [mass] of turtles / 100"
...
This model gives an example of a chemical reaction, here the synthesis of water (O<sub>2</sub> + 2H<sub>2</sub> &rarr; 2H<sub>2</sub>O). The "NUMBER" Target Selection Policy is used to respect the stoichiometry of the reaction.

## HOW IT WORKS

Oxygen agents may react with two hydrogen agents at the same time to produce two water agents (see the file "matrix.txt").

## IODA NETLOGO FEATURES

You certainly notice that the 1-2 first ticks are very slow: this is due two the combination of two processes:  

  1. the first run of concrete primitives is slow due to the compilation of the code,  
  2. at the beginning of the experiment, there is a huge number of active agents (1000 oxygen + 2000 hydrogen), and each oxygen is surrounded by many potential targets; thus the interaction selection process takes a lot of time. 
