...
This model is a simple NetLogo program used to introduce the specificities of the IODA NetLogo extension compared to classical NetLogo programming. In this model, particles move around and destroy one the other.
